...
import { square_item, square_item_img, square_item_img_textbox, square_item_contributors } from './SmallBoxTheme.module.scss'

const SmallBoxTheme = ({ authorsCollection, heroImage, heroHeading, style, style_big }) => {
