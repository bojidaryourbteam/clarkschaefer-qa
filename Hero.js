...
import { hero, hero_content, hero_content_border, hero_textbox, hero_filters, hero_wrapper, decoration, no_image, button_wrapper, theme_left, theme_right } from './Hero.module.scss'
...
const Hero = ({
  ...
  const classes = classNames(hero_wrapper, [themeOptions[position], no_image])
  const heroFilters = (
    <div className={hero_filters}>
      ...
      <div>
        ...
        <Button url='#' label='see all' theme='text' internalTitle='hero-filter-btn' />
      </div>
    </div>
  )
